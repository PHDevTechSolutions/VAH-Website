...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Prepare Inquiry Data for Firestore
      const inquiryData = {
      ...
      // 2. Record lead in Firestore 'inquiries' collection
      ...
      const response = await fetch("/api/solutions/send-catalogs", {
        ...
        body: JSON.stringify({
          ...formData,
          inquiryId: docRef.id,
          catalogs: inquiryData.requestedItems,
        }),
      });
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3">
              ...
              <p className="text-gray-500 mb-10">
                Complete the form below to receive detailed technical
                datasheets.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white font-bold rounded-xl shadow-lg transition-all flex items-center justify-center gap-3"
                >
                  {loading ? (
                    <>
