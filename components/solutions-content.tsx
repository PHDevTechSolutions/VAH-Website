  ...
  const fallbackData = [
    {
      ...
      products: [
        {
          category: "BUILDCHEM HP Series",
          items: [
            {
              name: "HP 1000",
              pdfUrl: "https://example.com/catalogs/hp-1000.pdf",
            },
            {
              name: "HP 515",
              pdfUrl: "https://example.com/catalogs/hp-515.pdf",
            },
          ],
        },
        {
          ...
          items: [
            {
              name: "PC 700",
              pdfUrl: "https://example.com/catalogs/pc-700.pdf",
            },
            {
              name: "PC 800",
              pdfUrl: "https://example.com/catalogs/pc-800.pdf",
            },
            {
              name: "PC 900",
              pdfUrl: "https://example.com/catalogs/pc-900.pdf",
            },
            {
              name: "PC 1000",
              pdfUrl: "https://example.com/catalogs/pc-1000.pdf",
            },
            {
              name: "PC 1100",
              pdfUrl: "https://example.com/catalogs/pc-1100.pdf",
            },
            {
              name: "PC 1180",
              pdfUrl: "https://example.com/catalogs/pc-1180.pdf",
            },
            { name: "RCC", pdfUrl: "https://example.com/catalogs/rcc.pdf" },
          ],
        },
        {
          category: "BUILDCHEM SI Series",
          items: [
            {
              name: "SI 90-112",
              pdfUrl: "https://example.com/catalogs/si-90-112.pdf",
            },
            {
              name: "SI 115-111",
              pdfUrl: "https://example.com/catalogs/si-115-111.pdf",
            },
            {
              name: "SI 102 AIR",
              pdfUrl: "https://example.com/catalogs/si-102-air.pdf",
            },
          ],
        },
      ],
    },
    {
      ...
      products: [
        {
          category: "BUILDCHEM Retarders",
          items: [
            {
              name: "BUILDCHEM RETARDER",
              pdfUrl: "https://example.com/catalogs/retarder.pdf",
            },
            {
              name: "BUILDCHEM STABLE",
              pdfUrl: "https://example.com/catalogs/stable.pdf",
            },
          ],
        },
        {
          category: "BUILDCHEM SET Series",
          items: [
            {
              name: "BUILDCHEM SET 100",
              pdfUrl: "https://example.com/catalogs/set-100.pdf",
            },
            {
              name: "BUILDCHEM SET 500",
              pdfUrl: "https://example.com/catalogs/set-500.pdf",
            },
            {
              name: "BUILDCHEM SET 500P",
              pdfUrl: "https://example.com/catalogs/set-500p.pdf",
            },
          ],
        },
      ],
    },
    {
      ...
      products: [
        {
          category: "BUILDCHEM UW Series",
          items: [
            {
              name: "BUILDCHEM UW",
              pdfUrl: "https://example.com/catalogs/uw.pdf",
            },
            {
              name: "BUILDCHEM UW50",
              pdfUrl: "https://example.com/catalogs/uw50.pdf",
            },
            {
              name: "BUILDCHEM BP ENERGY-100",
              pdfUrl: "https://example.com/catalogs/bp-energy-100.pdf",
            },
          ],
        },
      ],
    },
    {
      ...
      products: [
        {
          category: "BUILDCHEM WP Series",
          items: [
            {
              name: "BUILDCHEM WP®10L",
              pdfUrl: "https://example.com/catalogs/wp-10l.pdf",
            },
            {
              name: "BUILDCHEM WP®20",
              pdfUrl: "https://example.com/catalogs/wp-20.pdf",
            },
            {
              name: "BUILDCHEM SBX 100",
              pdfUrl: "https://example.com/catalogs/sbx-100.pdf",
            },
          ],
        },
      ],
    },
    {
      ...
      products: [
        {
          category: "BUILDCHEM SSTAB Series",
          items: [
            {
              name: "BUILDCHEM SSTAB-1000",
              pdfUrl: "https://example.com/catalogs/sstab-1000.pdf",
            },
            {
              name: "BUILDCHEM SSTAB-2000",
              pdfUrl: "https://example.com/catalogs/sstab-2000.pdf",
            },
          ],
        },
      ],
    },
    {
      ...
      products: [
        {
          category: "BUILDCHEM FORM Series",
          items: [
            {
              name: "BUILDCHEM DE-BONDING AGENT",
              pdfUrl: "https://example.com/catalogs/debonding-agent.pdf",
            },
            {
              name: "BUILDCHEM FORM MRA",
              pdfUrl: "https://example.com/catalogs/form-mra.pdf",
            },
            {
              name: "BUILDCHEM FORM WB10",
              pdfUrl: "https://example.com/catalogs/form-wb10.pdf",
            },
            {
              name: "BUILDCHEM FORM WB",
              pdfUrl: "https://example.com/catalogs/form-wb.pdf",
            },
          ],
        },
      ],
    },
    {
      ...
      products: [
        {
          category: "BUILDCHEM CI Series",
          items: [
            {
              name: "BUILDCHEM®CI 1000",
              pdfUrl: "https://example.com/catalogs/ci-1000.pdf",
            },
            {
              name: "BUILDCHEM®CNI 500",
              pdfUrl: "https://example.com/catalogs/cni-500.pdf",
            },
          ],
        },
      ],
    },
    {
      ...
      products: [
        {
          category: "BUILDCHEM CURE Series",
          items: [
            {
              name: "BUILDCHEM®CURE 100",
              pdfUrl: "https://example.com/catalogs/cure-100.pdf",
            },
            {
              name: "BUILDCHEM®CURE 150",
              pdfUrl: "https://example.com/catalogs/cure-150.pdf",
            },
          ],
        },
      ],
    },
    {
      ...
      products: [
        {
          category: "BUILDCHEM CEM Series",
          items: [
            {
              name: "BUILDCHEM®CEM 100",
              pdfUrl: "https://example.com/catalogs/cem-100.pdf",
            },
          ],
        },
      ],
    },
    {
      ...
      products: [
        {
          category: "BUILDCHEM ECO Series",
          items: [
            {
              name: "BUILDCHEM ECO CR",
              pdfUrl: "https://example.com/catalogs/eco-cr.pdf",
            },
          ],
        },
      ],
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        {isLoading ? (
          ...
          <div className="space-y-16 md:space-y-24">
            {displayData.map((sol) => {
              // Generate the slug once per item
              const slug = sol.title
                .toLowerCase()
                .trim()
                .replace(/[^\w ]+/g, "")
                .replace(/ +/g, "-");
              ...
              return (
                <div key={sol.index} id={slug} className="scroll-mt-24">
                  <SolutionsGrid
                    id={slug}
